<template>
  <div id="app">
    <b-navbar toggleable="lg" type="dark" variant="primary">
      <b-navbar-brand href="#">BBRhist (1.1)</b-navbar-brand>
    ...
    <b-container fluid>
        ...
        <div class="col" col-sm-6>
          <b-form @submit.stop.prevent>
            <b-form-group id="inputform">
              ...
              <b-form-select id="serviceselect" v-model="service" :options="bbrservices"></b-form-select>
            </b-form-group>
            <b-form-group>
      ...
      <div class="row">
        <div class="col col-sm-12">
          ...
          <p>Der er fundet {{ adresser.length }} instans(er)</p>
          <a
...
var auth = { username: "AYFPOEOPPT", password: "NuGa10s.." };
export default {
  data() {
    return {
      responseURL:
      ...
      displayURL:
        "https://services.datafordeler.dk/BBR/BBRPublic/1/REST/Bygning",
      idlokalId: "8557fc1b-21cc-40aa-a6ad-10586a832e7c",
      requestStatus: 0,
      adressebetegnelse: "",
      ...
      sampleUUID: [
        "8557fc1b-21cc-40aa-a6ad-10586a832e7c",
        "0a3f50a4-a914-32b8-e044-0003ba298018",
        "dbaef0ac-2803-45e0-a530-9c8035e1f22a",
  ...
  computed: {
    url() {
      return (
        "https://services.datafordeler.dk//BBR/BBRPublic/1/REST/" +
        this.service +
        "?id=" +
        this.idlokalId +
        "&username=" +
  ...
  methods: {
    ...
    darStatus(code) {
      return BBRStatusCode[code] + " (" + code + ")";
    },
    timeLabels(i) {
    ...
    getAdresse() {
      ...
      axios
        ...
        .then(res => {
          ...
          console.log("sortedtimestamp");
          console.table(this.sortedtimestamps);
          ...
          console.log("maxxlength : ", maxxlength);
          var lineHeight = 80;
